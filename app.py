...
border-radius:12px;padding:16px;margin-bottom:12px;">
    ...
    <div style="display:flex;justify-content:space-between;margin-bottom:12px;">
        ...
        <span style="color:rgba(150,180,220,0.5);font-size:0.75rem;">
            {date_val}
        </span>
    </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:8px;margin-bottom:10px;">
        ...
        <!-- DATE (ou autre info utile) -->
        <div style="background:rgba(0,50,140,0.4);border:1px solid rgba(0,140,255,0.2);border-radius:8px;padding:10px;">
            <div style="color:rgba(140,180,230,0.55);font-size:0.65rem;">DATE</div>
            <div style="color:#ffffff;font-weight:700;font-size:0.9rem;">{date_val}</div>
        </div>
